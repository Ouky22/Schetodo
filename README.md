...
See [SchetodoSynchronizationService](https://github.com/Ouky22/SchetodoSynchronizationService) 
for a Spring Boot application that will provide synchronization functionality for Schetodo.
