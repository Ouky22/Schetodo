...
import com.example.schetodo.feature.todos.add_edit_category.AddEditTodoCategoryEvent
...
internal class AddEditTodoCategoryViewModelTest {
    ...
    fun when_marking_todo_category_for_deletion_then_all_sub_categories_are_marked_for_deletion() =
        runTest {
            ...
            viewModel.onEvent(MarkTodoCategoryForDeletion)
    ...
    fun when_saving_and_invalid_category_name_do_not_save_and_show_error() = runTest {
        ...
        viewModel.onEvent(ChangeTodoCategoryName("  "))
        viewModel.onEvent(SaveTodoCategory)
    ...
    fun when_add_and_save_category_it_is_added_accordingly() = runTest {
        ...
        viewModel.onEvent(ChangeTodoCategoryName(categoryName))
        viewModel.onEvent(ChangeTodoCategoryIcon(categoryIcon))
        viewModel.onEvent(ChangeTodoCategoryColor(categoryColor))
        viewModel.onEvent(SaveTodoCategory)
    ...
    fun when_edit_and_save_category_it_is_edited_accordingly() = runTest {
        ...
        viewModel.onEvent(ChangeTodoCategoryName(newCategoryName))
        viewModel.onEvent(ChangeTodoCategoryIcon(newCategoryIcon))
        viewModel.onEvent(ChangeTodoCategoryColor(newCategoryColor))
        viewModel.onEvent(SaveTodoCategory)
    ...
    fun when_todo_category_name_changed_then_it_is_updated() {
        ...
        viewModel.onEvent(ChangeTodoCategoryName(newName))
    ...
    fun when_todo_category_color_changed_then_it_is_updated() {
        ...
        viewModel.onEvent(ChangeTodoCategoryColor(newColor))
    ...
    fun when_todo_category_icon_changed_then_it_is_updated() {
        ...
        viewModel.onEvent(ChangeTodoCategoryIcon(newIconName))
    ...
    fun when_todo_category_icon_selected_do_not_show_icon_picker_anymore() {
        ...
        viewModel.onEvent(ShowColorPicker)
        viewModel.onEvent(ChangeTodoCategoryIcon(Icons.Filled.Category.name))
    ...
    fun when_todo_category_color_selected_do_not_show_color_picker_anymore() {
        ...
        viewModel.onEvent(ShowColorPicker)
        viewModel.onEvent(ChangeTodoCategoryColor(0xaaffeedd))
    ...
    fun on_show_todo_category_icon_selection_only_show_icon_picker() {
        ...
        viewModel.onEvent(ShowColorPicker)
        viewModel.onEvent(ShowIconPicker)
