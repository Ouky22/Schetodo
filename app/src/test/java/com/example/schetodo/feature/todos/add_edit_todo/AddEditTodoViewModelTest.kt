...
internal class AddEditTodoViewModelTest {
    ...
    fun when_in_editing_mode_and_mark_todo_for_deletion_then_todo_marked_for_deletion() = runTest {
        ...
        viewModel.onEvent(MarkTodoForDeletion)
    ...
    fun when_in_adding_mode_and_delete_todo_event_happens_throw_exception() = runTest {
        ...
        assertThrows(Exception::class.java) { viewModel.onEvent(MarkTodoForDeletion) }
    }
    ...
    fun test_editing_and_saving_todo() = runTest {
        ...
        viewModel.onEvent(ChangeTodoDescription(newDescription))
        viewModel.onEvent(ChangeTodoPriority(newPriority))
        viewModel.onEvent(ChangeTodoFlag(newTodoFlag))
        viewModel.onEvent(SaveTodo)
    ...
    fun test_adding_and_saving_todo() = runTest {
        ...
        viewModel.onEvent(ChangeTodoPriority(priority))
        viewModel.onEvent(ChangeTodoFlag(todoFlag))
        viewModel.onEvent(SaveTodo)
